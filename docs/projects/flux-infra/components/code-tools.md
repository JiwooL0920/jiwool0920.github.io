...
| **Status** | Enabled |
| **Source** | [`apps/base/code-tools/`](https://github.com/JiwooL0920/fleet-infra/tree/develop/apps/base/code-tools/) |
...
- [`apps/base/code-tools/`](https://github.com/JiwooL0920/fleet-infra/tree/develop/apps/base/code-tools/) — Kubernetes manifests
- [`base/services/code-tools.yaml`](https://github.com/JiwooL0920/fleet-infra/blob/develop/base/services/code-tools.yaml) — Flux Kustomization
