...
This section documents all 31 services deployed in the fleet-infra platform, organized by their dependency layer.
...
|---------|---------|--------|
| [Cilium](cilium.md) | eBPF-based CNI network plugin | - |
...
| [KEDA](keda.md) | Event-driven autoscaler for Kubernetes | - |
| [Grafana Operator](grafana-operator.md) | Declarative Grafana dashboard management | - |
| [Grafana Config](grafana-config.md) | Grafana datasources and config | - |
| [Grafana Dashboards](grafana-dashboards.md) | Pre-built Grafana dashboard definitions | - |
...
## Security & Cost Observability (Layer 3)

| Service | Purpose | Access |
|---------|---------|--------|
| [Kubescape](kubescape.md) | CVE scanning, RBAC audit, misconfiguration detection | - |
| [OpenCost](opencost.md) | Kubernetes cost monitoring with MCP server | `http://opencost.local` |
...
| Service | Purpose | Access |
|---------|---------|--------|
| [Ollama](ollama.md) | Local LLM inference backend | - |
| [Code Tools](code-tools.md) | FastMCP server: Python execution, HTTP, mem0 memory | - |
| [kagent](kagent.md) | Kubernetes-native AI agent platform (CNCF Sandbox) | `http://kagent.local` |
| [AgentGateway](agentgateway.md) | A2A routing and MCP federation hub | - |
