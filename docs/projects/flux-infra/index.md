...
GitOps infrastructure platform managing **31 services** across multi-environment Kubernetes clusters with automated deployment, monitoring, and high availability.
...
|----------|-----------------|----------|
| **Foundation** | 10 | Cilium, Traefik, LocalStack, CNPG Operator, Metrics Server, KEDA |
| **Observability** | 8 | Kube-Prometheus-Stack, Weave GitOps, Loki, Promtail, Jaeger, OpenTelemetry, Grafana Operator |
| **Security & Cost** | 2 | Kubescape, OpenCost |
| **Databases** | 3 | PostgreSQL Cluster, Redis Sentinel, ScyllaDB |
| **Applications** | 2 | N8N, Temporal |
| **DB Management** | 2 | pgAdmin4, RedisInsight |
| **AI Platform** | 4 | Ollama, Code Tools, kagent, AgentGateway |
| **Disabled** | 3 | Crossplane suite, Scylla Manager |
